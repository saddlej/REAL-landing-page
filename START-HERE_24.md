...
**Priority 2 — Work through remaining future builds list in order.**

**Priority 3 — Clean slate member journey (DEFERRED — do after full product is built):**
Do NOT do this until every remaining build item is complete. Then: delete test data in Supabase, delete test account, sign up fresh as a real paying member and go through the full journey.
